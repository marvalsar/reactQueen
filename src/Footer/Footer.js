          ...
          <footer className="container-fluid bg-dark text-white p-3 mt-5">
            <div className="row">
                <div className="col-12 col-md-6 ">
                    <h4 className="text-center">&copy; Luz Marina Marin Aguirre</h4>
                ...
                <div className="col-12 col-md-6 border-start aligne-self-center">
                    <a href="https://github.com/marvalsar" className="text-light">
                    <i class="bi bi-github fs-1 m-5 p-5"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/luz-marina-marin-aguirre" className="text-light">
